...
public class OptimalLARACAlgorithmTest extends ConstrainedShortestPathAlgorithmTest {
    @Before
    public final void setupAlgorithm() throws Exception {
	    ...
	    proxy = new PathPlumberProxy(new int[]{0},
			    ...
			    new int[]{1},
			    new int[0]);
	    routingAlgorithmUnderTest =new LARACAlgorithm(controller, new YenAlgorithm(controller), 0);
