...
public class uqpaPathBasedTest extends ShortestPathAlgorithmTest {
	@Before
	public void setUp() {
		super.setUp();
		...
		proxy = new PathPlumberProxy(new int[]{0},
				...
				new int[]{1,2},
				new int[0]);
		routingAlgorithmUnderTest =new UniversalPriorityQueueAlgorithm(controller, QueueMode.PATH_LOOP_DETECTION,true, true);
