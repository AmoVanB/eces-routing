...
public class uqpaDijkstraTest extends ShortestPathAlgorithmTest {
	@Before
	public void setUp() {
		super.setUp();
		...
		proxy = new PathPlumberProxy(new int[]{0},
				...
				new int[0],
				new int[0]);
		routingAlgorithmUnderTest =new UniversalPriorityQueueAlgorithm(controller, QueueMode.NODE,true);
